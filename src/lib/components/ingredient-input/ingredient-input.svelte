<script>
	...
	import { dropAnimation, sensors } from '$lib/components/dnd-utils';
	import Droppable from '$lib/components/droppable.svelte';

	import Section from '$lib/components/ingredient-input/section.svelte';
	import Ingredient from '$lib/components/ingredient-input/ingredient.svelte';
